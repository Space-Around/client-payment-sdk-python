...
params = {
    'amount': 10,
    'merchant_id': 15,
    'order': '241eeda4-7491-11ec-9c7f-0242ac130011',
    'product_id': 15,
    'notification_url': 'https://918a-91-241-13-31.ngrok.io/webhooks'
}
...
print(f'url: {result.url}, payment_redirect_url: {result.payment_redirect_url}')
